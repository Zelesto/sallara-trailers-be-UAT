...
public interface PodRepository extends JpaRepository<Pod, Long> {
    ...
    /**
     * Trip Finalization - Count PODs by trip ID and status in list
     */
    ...
    /**
     * Trip Finalization - Count PODs by trip ID and status not in list
     */
    ...
    /**
     * Trip Finalization - Find all PODs for a trip with specific statuses
     */
    ...
    /**
     * Trip Finalization - Find all PODs for a trip with status not in list
     */
